...
%% Project 3. (part 1)
% Implementation of A Star Algorithm on Obstacle Space of Project 2
...
filledCircle([xcircle,ycircle],r,1000,'b'); 

%% Taking Input from User

resolution=1;%Resolution can be changed depending on User. Please note that with increase in resolution, path found may slightly go into the obstacles. I recommend to keep resolution as 1
